...
<html lang="pt-br">
  ...
  <header>
      ...
      <a class="navbar-brand" href="${pageContext.request.contextPath}/backoffice"><i class="fas fa-gamepad-alt"></i>Loja de Games</a>
  ...
  <body>
      <div class="page-title">
          <h1>Mais Vendidos <c:out value="${filialAttr}" /></h1>
      </div>
