...
<html lang="pt-br">
    ...
    <header>
        <nav class="navbar navbar-light nav-color">
            <a class="navbar-brand" href="${pageContext.request.contextPath}/rh"><i class="fas fa-gamepad-alt"></i>Loja de Games</a>
    ...
    <body>
        ...
        <form method="get" action="${pageContext.request.contextPath}/rh/pesquisa-de-funcionario" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
              <label for="inputCpf" class="col-md-1 offset-md-2">CPF:</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="cpf" id="inputCpf" placeholder="Digite o cpf do funcionário" onkeypress="$(this).mask('000.000.000-00');" required>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <form action="${pageContext.request.contextPath}/rh/excluir-funcionario" method="post">
